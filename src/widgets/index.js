...
ChoiceList.register("insertMenu", "main", {label: "Choice List", command: "insert", rank: 87})
CheckList.register("insertMenu", "main", {label: "Check List", command: "insert", rank: 88})
